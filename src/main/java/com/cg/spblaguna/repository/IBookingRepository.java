...
public interface IBookingRepository extends JpaRepository<Booking, Long> {
    ...
    @Query(value = """
            ...
            DATE_FORMAT(DATE_SUB(CURRENT_DATE(), INTERVAL n.n MONTH), '%Y-%m') AS month_year,
                ...
                FROM
                    (SELECT 0 AS n UNION ALL SELECT 1 UNION ALL SELECT 2 UNION ALL SELECT 3 UNION ALL SELECT 4 UNION ALL SELECT 5 UNION ALL SELECT 6 UNION ALL SELECT 7 UNION ALL SELECT 8 UNION ALL SELECT 9 UNION ALL SELECT 10 UNION ALL SELECT 11 UNION ALL SELECT 12) AS n
            LEFT JOIN
